...
export const meta = {
  author: 'mrdotb',
  date: '2023-07-29',
  title: 'How to Implement JavaScript Code Splitting in Phoenix 1.7: A Step-by-step Guide',
  tags: ['elixir', 'phoenix', 'esbuild', 'javascript'],
  description: 'Leverage the power of ESBuild\'s code splitting in your Phoenix 1.7 project to optimize load times and improve your app\'s performance. This detailed guide walks you through the process.',
}

...
export const meta = {
  author: 'mrdotb',
  date: '2022-01-16',
  title: 'Exclusive Belongs To Association in Phoenix using Ecto',
...
The original article from hashrocket [exclusive-belongs-to-aka-exclusive-arc-](https://hashrocket.com/blog/posts/modeling-polymorphic-associations-in-a-relational-database#exclusive-belongs-to-aka-exclusive-arc-)

## Table of contents

## Diagram

<SingleLightbox src={diagram} alt="diagram exclusive belongs to with datagrip" />

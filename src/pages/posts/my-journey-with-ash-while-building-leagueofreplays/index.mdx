...
export const meta = {
  ...
  description: 'Discover the development of LeagueOfReplays, an open-source project for replaying professional League of Legends games using Ash and Elixir. This concise overview covers the project\'s architecture, the advantages of using Ash, community support, and the challenges faced during development.',
}

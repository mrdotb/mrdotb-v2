...
import _2_flow_diagram from './2-flow-diagram.png'
import _3_game_details from './3-game-details.png'
import _4_flow_broadcast from './4-flow-broadcast.png'
...
Create `game_live/ddragon_component.ex`
```elixir
...
Create `game_live/grid_element_component.ex`
```elixir
...
Create `game_live/row_component.ex`
```elixir
...
<SingleLightbox src={_2_flow_diagram} alt="probuild ex flow diagram" />
...
Edit `game_live/index.html.heex` at the top of the file add the `alias` and the `import`
```elixir
...
<SingleLightbox src={_3_game_details} alt="probuild ex game details screenshot" />
...
<SingleLightbox src={_4_flow_broadcast} alt="probuild ex game details screenshot" />

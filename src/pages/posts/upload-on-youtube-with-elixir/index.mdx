...
<SingleLightbox src={_3_setup_oauth_consent_screen_1} alt="setup oauth consent screen 1" />



Fill the mandatory fields App name, User support email and Email addresses.

<SingleLightbox src={_3_setup_oauth_consent_screen_2} alt="setup oauth consent screen 2" />



Add or remove scopes.

<SingleLightbox src={_3_setup_oauth_consent_screen_3} alt="setup oauth consent screen 3" />



Tick youtube and youtube upload then update.

<SingleLightbox src={_3_setup_oauth_consent_screen_4} alt="setup oauth consent screen 4" />



Add a test user this user is the google who own the youtube channel you want to upload.

<SingleLightbox src={_3_setup_oauth_consent_screen_5} alt="setup oauth consent screen 5" />

...
_A league of legend probuilds provide easy access league of legends to Pro players builds across regions ex: ([probuilds.net](https://www.probuilds.net/), [probuildstats.com](https://probuildstats.com/))_
...
It give us our worst queries. _This is the result on my local machine. It's 6 to 8 times slower on the production fly.io postgres_
...
The step that takes the most time in this plan is the "Sort" step with a cost of 15181.497..15185.221. _We ignore "LIMIT" and "Gather Merge" step because they are parent step_
...
Be sure to sign up to the newsletter so that you won't miss my next article. I appreciate if you can star ⭐ the companion code [repo](https://github.com/mrdotb/probuild_ex).

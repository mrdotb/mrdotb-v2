...
import _2_screenshot_page from './2-screenshot-page.png'
import _3_screenshot_page from './3-screenshot-page.png'
import _4_screenshot_page from './4-screenshot-page.png'
...
<SingleLightbox src={_2_screenshot_page} alt="What it will look like" />

[The invoice printed in pdf ](/posts/render-beautiful-pdf-invoice-with-phoenix-and-pagedjs/1-invoice-sample.pdf)
...
document
  .querySelector('.button-print')
  .addEventListener('click', (_e) => window.print())
```
...
<Image src={_3_screenshot_page} alt="What it should look like" />
...
<div class="grid-2">
  <div>
    ...
    <div class="text-lg font-bold uppercase text-slate-900">
      <%= @invoice.seller.name %>
    </div>
...
<%# wrapping content with a no-break class prevent the content to break on
multiples pages %>
<div class="no-break">
  <div class="mt-8 font-bold text-slate-900"><%= @invoice.title %></div>
...
<div class="no-break">
  <div class="mt-8 font-bold text-slate-900">Payment information</div>
  <div class="mt-4 text-slate-500">
    ...
    <div>
      To use as a label on your bank transfer to identify the transaction
    </div>
    <div class="bg-lightblue mt-4 p-4">

...
import _1_search_and_filter from './1-search-and-filter.png'
import _2_load_more from './2-load-more.png'
import _3_intersection_observer from './3-intersection-observer.png'
...
<SingleLightbox src={_1_search_and_filter} alt="Search and filter implemented" />
...
<SingleLightbox src={_3_intersection_observer} alt="intersection observer image" />
...
<SingleLightbox src={_2_load_more} alt="infinite scroll" />
